...
values ('matheus','matheus@usuario',md5('12345'));
...
-- selecionar usuarios 
insert into usuarios (usuario, login, senha)
values ('lucas','lucas@usuario',md5('12345'));

insert into usuarios (usuario, login, senha)
values ('gabriel','gabriel@usuario',md5('90909'));

insert into usuarios (usuario, login, senha)
values ('junior','junior@usuario',md5('45678'));

insert into usuarios (usuario, login, senha)
values ('amanda','amanda@usuario',md5('11223'));

insert into usuarios (usuario, login, senha)
values ('wagner','wagner@usuario',md5('66666'));
