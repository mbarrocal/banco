...
-- criando contatos 
select * from contatos where nome='lucas';
select * from contatos where nome='gabriel';
select * from contatos where nome='junior';
select * from contatos where nome='amanda';
select * from contatos where nome='wagner';
select * from contatos where nome='pedro';
select * from contatos where nome='marcia';
select * from contatos where nome='maria';
select * from contatos where nome='igor';
select * from contatos where nome='kelly';

-- insert

Insert into contatos (nome,fone,email)
values ('lucas','99999-5555','lucas@email.com');
select * from contatos where id=10;


Insert into contatos (nome,fone,email)
values ('gabriel','99999-6666','gabriel@email.com');

Insert into contatos (nome,fone)
values ('junior','99999-7777');

Insert into contatos (nome,fone)
values ('amanda','99999-8888');

Insert into contatos (nome,fone,email)
values ('wagner','99999-9999','wagner@email.com');

Insert into contatos (nome,fone,email)
values ('pedro','99999-7171','pedro@email.com');

Insert into contatos (nome,fone,email)
values ('marcia','99999-1010','marcia@email.com');

Insert into contatos (nome,fone,email)
values ('maria','99999-1111','maria@email.com');
